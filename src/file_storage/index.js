...
import { idlFactory } from './file_storage.did.js';
export { idlFactory } from './file_storage.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FILE_STORAGE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./file_storage.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the file_storage canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./file_storage.did.js")._SERVICE>}
 */
export const file_storage = createActor(canisterId);
