...
import { idlFactory } from './file_scaling_manager.did.js';
export { idlFactory } from './file_scaling_manager.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FILE_SCALING_MANAGER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./file_scaling_manager.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the file_scaling_manager canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./file_scaling_manager.did.js")._SERVICE>}
 */
export const file_scaling_manager = createActor(canisterId);
